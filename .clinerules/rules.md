...
This project uses Python, Gemini, Claude, and Click.
...
**Python** (11 packages): Click, PyYAML, Pathspec, Pydantic, TQDM, Google-GenerativeAI, Groq, Python-Env, GitPython, Rich, Tomli

## DO (must follow)

- Always run `pytest` before committing; add tests for new features
...
1. Start with AI that knows your project.
...
1. Consider adding more logical flow between sections
2. Define technical terms used in the documentation
3. Provide more concrete examples for the 'DO' and 'DON'T' sections
4. Use consistent formatting for code examples and workflows
5. Add more context to the 'AGENT SKILLS' section

## Improvement Guidelines

### Clarity Improvements

**Define Technical Terms** - Add a glossary section:
## Glossary
