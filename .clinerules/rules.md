...
The purpose of this project is to provide a set of rules and guidelines for coding and contributing to the project. These rules aim to ensure consistency, quality, and maintainability of the codebase.

## PROJECT TYPE

This project is a Python command-line interface (CLI) built using the Click library.
...
- **Detected patterns:** python-cli, pytest-tests
- **Languages:** python
