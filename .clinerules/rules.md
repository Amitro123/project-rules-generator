...
## QUALITY ANALYSIS (SCORE: 90/100)

- **Structure**: 19/20
- **Clarity**: 18/20
- **Project Grounding**: 17/20
- **Actionability**: 19/20
- **Consistency**: 17/20

## SPECIFIC ISSUES TO FIX
1. Improve documentation for project tools and configuration files.
2. Add more examples for developers to follow in the "DO" and "DON'T" sections.
3. Standardize formatting throughout the document.
