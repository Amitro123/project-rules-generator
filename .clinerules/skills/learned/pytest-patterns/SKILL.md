...
description: |
  PYTEST patterns for this project. Use when user mentions "audit pytest", "pytest patterns", "review pytest". Do NOT activate for "general pytest questions", "pytest theory", "production deployment".
license: MIT
...
metadata:
  ...
  version: 1.0.0
  category: project
  tags: [pytest, patterns, gitpython, jinja2, groq, python]
---
...
This skill provides step-by-step guidance for pytest patterns.
...
Signals: has_tests, has_docs, has_api, has_ci
Tech Stack: gitpython, jinja2, groq, python, gemini, pydantic, click, pytest
```
