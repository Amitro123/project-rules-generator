...
class TestDesignToMarkdown:
    ...
    def test_renders_architecture_decisions(self):
        d = Design(
            ...
            architecture_decisions=[
                ArchitectureDecision(
                    title="Approach", choice="Redis", alternatives=["Memcached"],
                    pros=["Fast"], cons=["Extra infra"],
                ),
            ],
        )
        md = d.to_markdown()
...
class TestDesignFromMarkdown:
    ...
    def test_roundtrip(self):
        original = Design(
            ...
            architecture_decisions=[
                ArchitectureDecision(
                    title="Auth Method", choice="JWT tokens", alternatives=["sessions"],
                    pros=["Stateless"], cons=["Revocation complexity"],
                ),
            ],
...
class TestDesignCLI:
    ...
    def test_design_generates_file(self, tmp_path):
        (tmp_path / 'README.md').write_text('# Test Project\n\nA project.')

        runner = CliRunner()
        result = runner.invoke(cli, [
            'design', 'Add authentication to API',
    ...
    def test_design_custom_output(self, tmp_path):
