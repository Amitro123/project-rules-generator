...
def test_learned_skill_deduped_when_project_skill_exists_2part(tmp_path):
    ...
    assert parsed["skills_count"]["learned"] == 0, "2-part learned ref not deduped when project/ version exists"
...
def test_learned_skill_deduped_when_project_skill_exists_3part():
    ...
    assert parsed["skills_count"]["project"] == 1
    assert parsed["skills_count"]["learned"] == 0, "3-part learned ref should not appear when project/ version exists"
