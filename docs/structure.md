...
- **`.agents/rules/<project-name>.md`**: Auto-loaded project rules for Claude Code / Windsurf. Contains project context, tech stack, architecture summary, and coding conventions. Always generated by `prg analyze`.
