...
@click.option(
    "--discovery-only", is_flag=True, help="Stop after rule generation and task creation"
)
@click.option(
    "--execute-only", is_flag=True, help="Assume tasks exist and start execution loop"
)
@click.option(
    "--provider",
