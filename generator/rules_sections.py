"""Section-builder helpers for legacy rules generation.

Separated from rules_generator.py to keep the orchestrator class thin.
All functions operate only on plain dicts and strings — no I/O.

Import directly for new code:
    from generator.rules_sections import _build_context_strategy
"""
