...
class CodeExampleExtractor:
    ...
    TOPIC_PATTERNS = {
        ...
        'cli': {
            'decorators': ['click.command', 'click.option', 'click.argument', 'click.group'],
        ...
        for node in ast.walk(tree):
            ...
            # Class definitions
                ...
                for pattern in search_patterns.get('classes', []):
                    ...
                    if (pattern.lower() in class_name.lower() or
                            any(pattern.lower() in b.lower() for b in base_names)):
