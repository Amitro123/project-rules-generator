    ...
    def _generate_template_roadmap(self, features: List[str], readme_content: str) -> Plan:
        ...
        phases = [
            Phase(
                ...
                tasks=[
                    Task("Set up project structure", ["Create directory layout", "Initialize configuration"]),
                    Task("Configure development environment", ["Set up linting", "Configure testing framework"]),
                    Task("Implement core modules", ["Create base classes", "Set up utilities"])
                ]
            ),
            Phase(
                ...
                tasks=[
                    Task(f"Implement {features[0]}", ["Design API", "Write implementation", "Add tests"]) if features else
                    Task("Implement core features", ["Design API", "Write implementation", "Add tests"]),
                ]
            ),
            Phase(
                ...
                tasks=[
                    Task("Write comprehensive tests", ["Unit tests", "Integration tests", "E2E tests"]),
    ...
    def _generate_template_task_plan(self, query: str) -> Plan:
        ...
        phases = [
            Phase(
                ...
                tasks=[
                    Task("Research and understand requirements", ["Review existing code", "Identify dependencies"]),
                    Task("Set up development environment", ["Install dependencies", "Configure tools"])
                ]
            ),
            Phase(
                ...
                tasks=[
                    Task("Implement core functionality", ["Write main code", "Handle edge cases"]),
