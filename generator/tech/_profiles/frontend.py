...
FRONTEND: List[TechProfile] = [
    ...
    TechProfile(
        ...
        category="frontend",
        skill_name="",
        packages=["@tanstack/react-query", "@tanstack/query-core", "@tanstack/vue-query"],
        readme_keywords=["tanstack query", "tanstack", "react query", "react-query"],
    ),
    TechProfile(
        name="react-router",
        ...
        readme_keywords=["react router", "react-router"],
    ),
    TechProfile(
        name="shadcn",
        ...
        skill_name="",
        packages=[],
        readme_keywords=["shadcn", "shadcn/ui", "shadcn ui"],
        detection_files=["components.json"],
    ),
    TechProfile(
        name="konva",
        display_name="Konva",
